            ...
            success: function (msg) {
                ...
                msg.forEach(function (el) {
                    userText = userText + '<tr>'
                        ...
                        + '<td>' + '<button type="button" data-toggle="modal" id="edit'
                        + el.id + '" name="id" value="'
                        + el.id + '" class="btn btn-info" data-target="#editModal">Edit</button>' + '</td>'
                        + '<td>' + '<button type="button" class="btn btn-danger" id="delete'
                        + el.id + '" name="id" value="' + el.id + '">Delete</button>' + '</td>'
                        + '</tr>';
                })
